...
optimizer_g_l = optim.Adam(
    generator_lower.parameters(), lr=params.learning_rate, betas=(params.beta1, params.beta2)
)
...
for epoch in range(params.num_epochs):
    ...
    for step in range(critic_steps):
        ...
        image_tgt = make_lower_size(image_tgt)
        # make_variable
        ...
        gen_tgt = generator_lower(image_tgt)
    ...
    if ((epoch + 1) % params.save_step == 0):
        save_model(critic, "V1_WGAN-GP_critic-{}.pt".format(epoch + 1))
        save_model(classifier,
                   "V1_WGAN-GP_classifier-{}.pt".format(epoch + 1))
        save_model(generator, "V1_WGAN-GP_generator-{}.pt".format(epoch + 1))
        save_model(generator_lower,"V1_WGAN-GP_generator_lower-{}.pt".format(epoch + 1))
